...
const TradingInvestment = () => {
  ...
  const {data: investmentData, isLoading: isLoadingInvestmentTable} = useInvestmentDashboardtradingTable()
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("status", {
        ...
        cell: (info) => (
          <div
            className={` max-w-[100px] flex justify-center px-3 items-center py-[.5625rem] text-sm font-medium bg-transparent rounded-lg border-[0.3px] ${getStatusColor(convertKebabAndSnakeToTitleCase(info.getValue()))}`}
          >
        ...
        cell: (info) => (
          <div className="">
            <LinkButton
              ...
              className="text-white px-3 max-md:w-[100px] md:px-6 py-3 border-white border-[0.3px] border-opacity-50"
              variant="outlined"
            >
              View Details
            </LinkButton>
  ...
  return (
    <div className="md:px-8 px-3 py-6 bg-[#090E29] h-full">
     <div className="">
  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-0">
    ...
    {/* Filter button - shows here on desktop */}
    {/* <div className="hidden md:flex justify-end">
      <Button
        variant="outlined"
        className="bg-slate-700/50 h-[3rem] border-slate-600 text-white hover:bg-slate-700"
      >
        <FIlterIcon className="w-4 h-4 mr-2" />
        Filter
      </Button>

...
import { forexSignalsMockData, TradingSignalData } from '../../../trading-signal/mockData';
  ...
  return (
    <div>
      <div className='mt-4 border-b-[.0313rem] border-[#696969] border-opacity-50 pb-4'>
        <h1 className="md:text-2xl text-lg font-bold font-verdana text-white mb-2">Forex Trade Signal</h1>

...
import { SkeletonLoading } from '@/app/dashboard/(dashboard)/components/referral/ReferalTable';
...
const {data,isLoading}=useGetTransactionWalletTable()
...
// Option 1: Using optional chaining and nullish coalescing
    ...
    <div className='px-8 py-6 bg-[#090E29] h-full'>
        <div className="flex items-center justify-between">
          ...
          <h2 className="text-white font-bold font-verdana text-base">Recent Transactions</h2>
                    <div className="h-8 w-8 rounded-10 border-[0.4px] border-[#4453DD] flex justify-center items-center"><p className='text-white font-outfit text-xs font-medium'>{data?.data?.length??0}</p></div>
